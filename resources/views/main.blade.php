        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <article class="p-6 bg-post rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:text-primary"><a href="/threads/{{ $thread->slug }}">{{ Str::words($thread->title, 5) }}</a></h2>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <span class="font-medium dark:text-white">
                                {{ Str::words($thread->author->username, 2) }}
                            </span>
                        </div>
